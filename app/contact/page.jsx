    ...
    <div className='w-full h-full bg-zinc-800'>
      ...
      <div class="mapouter w-full">
        <div class="gmap_canvas w-full">
          <iframe className="gmap_iframe" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" src="https://maps.google.com/maps?width=800&amp;height=400&amp;hl=en&amp;q=hoa minh, lien chieu&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
          </iframe>
        </div>
      </div>
        <div className='py-7'>
